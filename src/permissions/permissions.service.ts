...
export class PermissionsService {
  ...
  async create(permissionData: Permission): Promise<any> {
    try {
      if (permissionData) {
        ...
        const createdPermission = await this.permissionRepository.save(newPermission);
  ...
  async findAll(): Promise<any> {
    try {
      const permissions = await this.permissionRepository.find({ where: { state: 'ACTIVO' } });
  ...
  async updatePermissionById(id, permissionData) {
    try {
      ...
      const updatedUser = await this.permissionRepository.save({
        ...existingPermission,
        ...permissionData,
      });
